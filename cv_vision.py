...
def findClickPositions(needle_img_path, haystack_img_path, threshold=0.5, debug_mode=None):
    ...
    haystack_img = cv.imread(f'./images/{haystack_img_path}.png', cv.IMREAD_UNCHANGED)
    needle_img = cv.imread(f'./images/{needle_img_path}.png', cv.IMREAD_UNCHANGED)
...
points = findClickPositions('mystery_shard_market', 'market_shards', debug_mode='points')
print(points)
